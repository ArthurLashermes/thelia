...
class BrandImageTest extends WebTestCase
{
    public function test__api__admin_brand_images_get_collection(): void
{
    $client = self::$client;
...
public function test__api__front_brand_images_get_collection(): void
{
    $client = self::$client;
