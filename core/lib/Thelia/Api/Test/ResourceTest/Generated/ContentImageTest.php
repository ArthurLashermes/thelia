...
class ContentImageTest extends WebTestCase
{
    public function test__api__admin_content_images_get_collection(): void
{
    $client = self::$client;
...
public function test__api__front_content_images_get_collection(): void
{
    $client = self::$client;
