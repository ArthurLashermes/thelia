...
class ProductImageTest extends WebTestCase
{
    public function test__api__admin_product_images_get_collection(): void
{
    $client = self::$client;
...
public function test__api__front_product_images_get_collection(): void
{
    $client = self::$client;
